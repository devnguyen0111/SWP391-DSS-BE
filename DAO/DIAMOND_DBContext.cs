...
public partial class DIAMOND_DBContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Address>(entity =>
        {
            entity.HasKey(e => e.AddressId).HasName("PK__Address__26A111AD9BED6CBD");
            ...
            entity.HasOne(d => d.Cus).WithMany(p => p.Addresses)
                .HasForeignKey(d => d.CusId)
                .HasConstraintName("FK__Address__cusId__6FE99F9F");
        });

        modelBuilder.Entity<Cart>(entity =>
        {
            entity.HasKey(e => e.CartId).HasName("PK__Cart__415B03B8F6D34C6C");
        ...
        modelBuilder.Entity<CartProduct>(entity =>
        {
            entity.HasKey(e => new { e.CartId, e.ProductId }).HasName("PK__CartProd__F38A0EAE4BF65370");
        ...
        modelBuilder.Entity<Category>(entity =>
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__23CAF1D86F8503F1");
        ...
        modelBuilder.Entity<Cover>(entity =>
        {
            entity.HasKey(e => e.CoverId).HasName("PK__Cover__B192A2E003235602");
        ...
        modelBuilder.Entity<CoverMetaltype>(entity =>
        {
            entity.HasKey(e => new { e.MetaltypeId, e.CoverId }).HasName("PK__CoverMet__F1356AB6E047EBC9");
        ...
        modelBuilder.Entity<CoverSize>(entity =>
        {
            entity.HasKey(e => new { e.SizeId, e.CoverId }).HasName("PK__CoverSiz__4EA8CF79A755B711");
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            entity.HasKey(e => e.CusId).HasName("PK__Customer__BA9897F3106B8CE8");
            ...
            entity.HasMany(d => d.Vouchers).WithMany(p => p.Cus)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("CusId", "VoucherId").HasName("PK__Customer__35CBAF6DD50C6552");
                        j.ToTable("CustomerVoucher");
                        j.IndexerProperty<int>("CusId").HasColumnName("cusId");
                        j.IndexerProperty<int>("VoucherId").HasColumnName("voucherId");
                    });
        ...
        modelBuilder.Entity<DeliveryStaff>(entity =>
        {
            entity.HasKey(e => e.DStaffId).HasName("PK__Delivery__C4E2975C0086F331");
        ...
        modelBuilder.Entity<Diamond>(entity =>
        {
            entity.HasKey(e => e.DiamondId).HasName("PK__Diamond__F848E6C0072E74A6");
        ...
        modelBuilder.Entity<Favorite>(entity =>
        {
            entity.HasKey(e => e.FavoriteId).HasName("PK__favorite__876A64D5469846CE");
        ...
        modelBuilder.Entity<FavoriteProduct>(entity =>
        {
            entity.HasKey(e => new { e.FavoriteId, e.ProductId }).HasName("PK__favorite__35BB69C3DC11E4FB");
        ...
        modelBuilder.Entity<Manager>(entity =>
        {
            entity.HasKey(e => e.ManId).HasName("PK__Manager__0A7A95EEEBB8DEF3");
        ...
        modelBuilder.Entity<Metaltype>(entity =>
        {
            entity.HasKey(e => e.MetaltypeId).HasName("PK__Metaltyp__EA2C4098A1039173");
        ...
        modelBuilder.Entity<Order>(entity =>
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Order__0809335D7BA54AD5");
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Product__2D10D16A6AF3F8C2");
        ...
        modelBuilder.Entity<ProductOrder>(entity =>
        {
            entity.HasKey(e => new { e.ProductId, e.OrderId }).HasName("PK__ProductO__ED90425FB6F5114F");
        ...
        modelBuilder.Entity<Review>(entity =>
        {
            entity.HasKey(e => e.ReviewId).HasName("PK__Review__2ECD6E0400D1CB29");
        ...
        modelBuilder.Entity<SaleStaff>(entity =>
        {
            entity.HasKey(e => e.SStaffId).HasName("PK__SaleStaf__7D4E9B95F4DC7F9F");
        ...
        modelBuilder.Entity<Shipping>(entity =>
        {
            entity.HasKey(e => e.ShippingId).HasName("PK__Shipping__EDF80BCAF632F1E0");
        ...
        modelBuilder.Entity<ShippingMethod>(entity =>
        {
            entity.HasKey(e => e.ShippingMethodId).HasName("PK__Shipping__E405E8563734547F");
        ...
        modelBuilder.Entity<Size>(entity =>
        {
            entity.HasKey(e => e.SizeId).HasName("PK__Size__55B1E55705A588EA");
        ...
        modelBuilder.Entity<SubCategory>(entity =>
        {
            entity.HasKey(e => e.SubCategoryId).HasName("PK__SubCateg__F82064691B92A0AB");
        ...
        modelBuilder.Entity<User>(entity =>
        {
            entity.HasKey(e => e.UserId).HasName("PK__User__CB9A1CFFD460BAF0");
        ...
        modelBuilder.Entity<Voucher>(entity =>
        {
            entity.HasKey(e => e.VoucherId).HasName("PK__Voucher__F53389E994C12037");
